...
const SingleProduct = () => {
  ...
  useEffect(() => {
    dispatch(getAProduct(getProductId)); // fetch product data using the id parameter
  }, []);
 ...
 /*  if (!product) {
  ...
  return (
    <>
      ...
      <BreadCrumb title={productState?.category} />
            ...
            <div className="main-product-details">
              ...
              <div className=" py-3">
                ...
                <div className="d-flex gap-10 align-items-center my-2">
                  ...
                  >
                    {productState?.stock < 1 ? "Out Of Stock" : "InStock"}
                  </p>
                </div>
